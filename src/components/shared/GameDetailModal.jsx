  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-20 pb-10 px-4 overflow-y-auto animate-backdrop-in">
      <div ref={modalRef} className="w-full max-w-2xl border border-border bg-surface p-8 relative flex flex-col my-auto animate-scale-in">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-text-secondary hover:text-text hover:border-accent border border-border p-2 transition-colors flex items-center justify-center btn-micro-bounce"
          aria-label="Close"
        >
        ...
        <div className="mt-8 pt-6 border-t border-border flex flex-col items-center space-y-4">
          ...
          {confirmDelete ? (
            ...
            <div className="flex flex-wrap justify-center gap-4 w-full">
              ...
              <button
                onClick={handleSave}
                className="px-8 py-2 border border-accent bg-accent/10 text-accent hover:bg-accent hover:text-white text-xs uppercase tracking-widest font-semibold transition-all duration-200 btn-micro-bounce"
              >
              ...
              <button
                onClick={onClose}
                className="px-8 py-2 border border-border text-text-secondary hover:border-text hover:text-text text-xs uppercase tracking-widest transition-all duration-200 btn-micro-bounce"
              >
                Cancel
              </button>
              ...
              {isExisting && (
                <button
                  ...
                  className="px-4 py-2 border border-red-500/30 text-red-400/80 hover:border-red-500 hover:text-red-500 text-xs uppercase tracking-widest transition-all duration-200 ml-auto sm:ml-0 btn-micro-bounce"
                >
                  Delete
                </button>
              )}
