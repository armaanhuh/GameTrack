          ...
          {AVAILABLE_PLATFORMS.map((plat) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 border text-sm font-medium transition-none ${
                  isOwned
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {platforms.map((plat) => {
          ...
          return (
            <div
              key={plat.key}
              className="border border-border bg-surface p-6 flex flex-col justify-between space-y-6"
            >
              {/* Header Title */}
              <div>
                            ...
                            {isEditing ? (
                              <>
                                {AVAILABLE_PLATFORMS.map((plat) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`text-[9px] px-2 py-0.5 border transition-none ${
                                        isOwned
                                ...
                                <button
                                  ...
                                  className="text-[9px] px-2 py-0.5 border border-border bg-bg text-text-secondary hover:border-accent hover:text-accent transition-all"
                                >
                                  Done
                                </button>
                              </>
                              ...
                              <>
                                ...
                                <button
                                  ...
                                  className="text-[9px] px-2 py-0.5 border border-border bg-bg text-text-secondary hover:border-text-secondary hover:text-text transition-all"
