    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-bg/80 backdrop-blur-md">
      <div className="w-full px-6 md:px-10 h-16 flex items-center justify-between relative">
        ...
        <div className="flex-shrink-0 z-10">
          <a href="#/dashboard" className="flex items-center text-2xl font-display font-semibold tracking-tight hover:opacity-85">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <a
                key={link.hash}
                href={link.hash}
                className={`flex items-center space-x-1.5 text-xs uppercase tracking-widest py-1 border-b font-medium transition-all duration-200 nav-link-hover ${
                  isActive
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between bg-bg/50 border border-border p-2 rounded-sm">
                      ...
                      <button
                        onClick={toggleTheme}
                        className="flex items-center space-x-1.5 px-3 py-1 border border-border bg-surface hover:border-accent hover:text-text rounded-sm text-xs transition-colors theme-btn-hover"
                      >
                        {theme === 'dark' ? (
                          <>
