    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-[rgba(15,15,15,0.95)] backdrop-blur-md p-4">
      <div className="w-full max-w-md border border-border bg-surface p-8 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full border border-accent bg-accent/10 text-accent hover:bg-accent hover:text-white text-xs uppercase tracking-widest font-semibold py-2.5 transition-all duration-200"
          >
            Activate Workspace
          </button>
        </form>
