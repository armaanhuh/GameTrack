    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-20 px-4 animate-backdrop-in">
      ...
      >
        ...
        <div className="flex items-center border-b border-border px-4 py-3">
          ...
          <button
            onClick={onClose}
            className="text-text-secondary hover:text-text text-xs uppercase tracking-widest border border-border px-2.5 py-1 hover:border-accent hover:text-accent transition-colors ml-2"
          >
            Esc
          </button>
        </div>
          ...
          {!loading && !error && results.map((game) => {
            ...
            return (
              <button
                ...
                className="w-full text-left px-6 py-4 flex items-center justify-between hover:bg-bg/40 transition-colors group"
              >
