  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-px bg-border border border-border">
        ...
        {/* Total Games */}
        <div className="bg-surface p-6 text-center flex flex-col justify-between items-center">
        ...
        <div className="bg-surface p-6 text-center col-span-2 lg:col-span-1 flex flex-col justify-between items-center">
              ...
              {recentActivities.map((act) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center justify-between p-4 hover:bg-bg/40 cursor-pointer group transition-colors"
                  >
          ...
          {suggestions.length === 0 ? (
            ...
            <div className="space-y-4">
              {suggestions.map((game) => (
                <div
                  key={game.id}
                  className="border border-border bg-surface p-5 hover:border-accent group transition-all duration-200"
                >
                  ...
                  <button
                    ...
                    className="w-full text-center border border-border hover:border-accent hover:text-accent text-[10px] uppercase tracking-widest font-medium py-1.5 transition-colors"
                  >
                    Open Details
                  </button>
                </div>
